package com.eaton.common.aspect;

import com.alibaba.fastjson.JSONObject;
import com.baomidou.mybatisplus.core.metadata.IPage;
import com.eaton.common.annotation.Dict;
import com.eaton.common.api.vo.Result;
...
public class DictAspect {
    ...
    @Autowired
    private SsoDictService dictService;
    // 定义切点Pointcut
    @Pointcut("execution(public * com.eaton.modules.*.*.*Controller.*(..))")
