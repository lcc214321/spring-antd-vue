package com.eaton.modules.sso.oauth2;
...
public class OAuth2Realm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        SsoUserTokenEntity tokenEntity = shiroService.queryByToken(accessToken);
        //token失效
        ...
        //查询用户信息
        SsoUserEntity user = shiroService.queryUser(tokenEntity.getUserId());
        //账号锁定
